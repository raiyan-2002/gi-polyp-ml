...
<img src="./assets/resnet_unet_training_history.png" alt="Sample Training Curve" width="650" />


The model comparison plot generated by `experiment.py` looks like this:

<img src="./assets/model_comparison.png" alt="Sample Comparison Plot" width="650" />

### Inference Scripts

Note: The following scripts will only work if you have trained the models using `experiment.py` or downloaded the model weights in the `checkpoints/` folder from the Google Drive link earlier in the README.
...
<img src="./assets/random_sample.png" alt="Sample Prediction Visualization" width="650" />
